                                ...
                                <table class="tds-s-table tds-s-table-subscr">
                                    ...
                                    <tbody class="tds-s-table-body">
                                        ...
                                        foreach ( $result['subscriptions'] as $key => $subscription ) {
                                            ...
                                            ?>
                                            <tr class="tds-s-table-row <?php echo ( $is_composer && $key == 0 ) ? 'tds-s-table-row-active tds-s-table-row-info-expanded' : ''; echo 'td-' . $subscription['status']?>" data-subscription-id="<?php echo $subscription['id'] ?>">
                                            ...
                                            <tr class="tds-s-table-row-extra-wrap tds-s-table-row-extra-wrap-info <?php echo 'td-' . $subscription['status']  ?>" <?php echo ( $is_composer && $key == 0 ) ? '' : 'style="display: none"' ?> data-belongs-to="<?php echo $subscription['id'] ?>">
                                                <td class="tds-s-table-row-extra" colspan="9">
                                                    <div class="tds-s-table-row-extra-inner">
                                                        <div class="tds-s-tre-cols">
