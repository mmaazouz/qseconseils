					    ...
					    if (count($year_plans)) {
						    ...
						    $buffy .= '<div class="tds-plans-price tds-show-plan-price ' . $default_plan_class . '" data-type="year">';
                                ...
                                if (!empty( $year_plans[ $year_plan ])) {
	                                $buffy .= '<div class="td-pp-price-txt">' . number_format( $year_plans[ $year_plan ][ 'price' ], intval($currency_dec_no), $currency_dec_sep, $currency_th_sep ) . '</div>';
					    ...
					    if (count($month_plans)) {
	                        ...
	                        $buffy .= '<div class="tds-plans-price tds-show-plan-price ' . $default_plan_class . '" data-type="month">';
                                ...
                                if (!empty($month_plans[ $month_plan ])) {
	                                $buffy .= '<div class="td-pp-price-txt">' . number_format( $month_plans[ $month_plan ][ 'price' ], intval($currency_dec_no), $currency_dec_sep, $currency_th_sep ) . '</div>';
