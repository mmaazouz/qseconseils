                            ...
                            $buffy .= '<div class="tdb-s-form-group tdb-posts-form-acf-input tdb-s-content" data-form-type="' . $form_type . '" data-type="' . $field_type . '" data-required="' . $field_required . '" data-name="' . $field_name . '">';
                                ...
                                switch ( $field_type ) {
                                    ...
                                    case 'time_picker':
                                        ...
                                        $buffy .= td_external_resources::render_script('//cdn.jsdelivr.net/npm/flatpickr', 'tdb-flatpickr-js');
                                        $buffy .= td_external_resources::render_style('//cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css', 'tdb-flatpickr-css');
