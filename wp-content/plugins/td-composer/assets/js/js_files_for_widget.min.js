...
c,m);m.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);a.isUndefined(h)?(d.addClass("tdc-hidden-button"),f.hide()):("no_value"===h?d.addClass("tdc-hidden-button"):(d.removeClass("tdc-hidden-button"),b.attr("style",'background-image: url("'+h+'")')),"all"!==tdcSidebar.currentViewportSettings.name&&f.show());b.data("image_link",h)});k(".tdc-inherit").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||
...
tdcCssEditor._getRgba(c.attr("placeholder"))):("no_value"===c.val()&&c.val(""),tdcCssEditor._checkDefaultColor(c))})},generateEditorResponsiveContent:function(){function b(){return m={isInherited:!1}}function e(a){return"all"!==tdcSidebar.currentViewportSettings.name?'placeholder="'+a+'"':""}function d(){return m.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function f(a,c){c=tdcCssEditor._getSettingsProperty(a,c,b());var e="-";m.isInherited&&(e=c,c="");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+
c+'" class="tdc-css-box-input tdc-css-box-input-'+a+d()+'" title="Css '+a+'" placeholder="'+e+'" '+tdcSidebarPanel._getParamterDataAtts(g,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var g=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,m={isInherited:!1};var h='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(g)+'">');h=h+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+f("margin-top","");h+=f("margin-right","");h+=f("margin-bottom",
"");h+=f("margin-left","");h=h+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+f("border-top-width","");h+=f("border-right-width","");h+=f("border-bottom-width","");h+=f("border-left-width","");h=h+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+f("padding-top","");h+=f("padding-right","");h+=f("padding-bottom","");h+=f("padding-left","");h+="</div></div></div></div>";var n=tdcCssEditor._getSettingsProperty("border-style",c,b());h+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+
...
{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],n);h+="</select></div></div>";n=a.uniqueId();var q=tdcCssEditor._getSettingsProperty("border-color","",b()),p="";m.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+
d()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+e(p)+' value="'+q+
'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("border-radius","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+d()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');
h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+d()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+="</div></div>";n=a.uniqueId();q=tdcCssEditor._getSettingsProperty("shadow-color","",b());p="";m.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+d()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=a.uniqueId();q=tdcCssEditor._getSettingsProperty("background-color","",b());p="";m.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+d()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' id="'+n+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",c,b());h+='<div class="tdc-property-wrap tdc-property-attach_image'+d()+'">';h=h+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");h+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';n=tdcCssEditor._getSettingsProperty("background-style",c,b());h+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+d()+'" data-tdc-for="background-style">';h=h+'<div class="tdc-property-title"><span title="Css background-size & background-repeat" class="tdc-search-data">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-bg-style" '+
...
"</select></div></div>";n=tdcCssEditor._getSettingsProperty("opacity","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
n=a.uniqueId();q=tdcCssEditor._getSettingsProperty("color-1-overlay","",b());p="";m.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+d()+'" data-tdc-for="color-1-overlay">';h=h+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' id="'+n+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";n=a.uniqueId();q=tdcCssEditor._getSettingsProperty("color-2-overlay","",b());p="";m.isInherited&&(p=q,q="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+d()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(q)+' id="'+n+'" name="" type="text" '+e(p)+' value="'+q+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",c,b());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+d()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);h+="</select></div></div>";"vc_row"!==l.get("tag")&&"vc_row_inner"!==l.get("tag")&&"vc_column"!==l.get("tag")&&"vc_column_inner"!==l.get("tag")&&(n=tdcCssEditor._getSettingsProperty("order","",b()),q="",m.isInherited&&(q=n,n=""),h+=
'<div class="tdc-property-wrap tdc-order tdc-textfield-small'+d()+'" data-tdc-for="order">',h=h+'<div class="tdc-property-title"><span title="Order" class="tdc-search-data">Order</span></div><div class="tdc-property"><input class="tdc-css-order" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>'),h+="</div></div>");n=tdcCssEditor._getSettingsProperty("z-index","",b());q="";m.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+
d()+'" data-tdc-for="z-index">';h=h+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(q)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",c);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+d()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+
...
l=!1,m=0,h=0;h<b.length;h++)a.isUndefined(d)||d!==b[h].value||(m=h),g="",a.isUndefined(c)||c!==b[h].value||(g='selected="selected"',l=!0),e.push("<option "+g+' value="'+b[h].value+'">'+b[h].display+"</option>");l||(e[m]='<option selected="selected" value="'+b[m].value+'">'+b[m].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var c={},d=b.find(".tdc-css-box-input-margin-top").val().trim(),f=b.find(".tdc-css-box-input-margin-right").val().trim(),g=b.find(".tdc-css-box-input-margin-bottom").val().trim(),
l=b.find(".tdc-css-box-input-margin-left").val().trim(),m=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),q=b.find(".tdc-css-box-input-border-left-width").val().trim(),p=b.find(".tdc-css-box-input-padding-top").val().trim(),k=b.find(".tdc-css-box-input-padding-right").val().trim(),r=b.find(".tdc-css-box-input-padding-bottom").val().trim(),x=b.find(".tdc-css-box-input-padding-left").val().trim(),
u=b.find(".tdc-css-border-radius").val().trim(),z=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),v=b.find(".tdc-css-shadow-offset-h").val().trim(),w=b.find(".tdc-css-shadow-offset-v").val().trim(),t=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim(),D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=d);""!==f&&(c["margin-right"]=
f);""!==g&&(c["margin-bottom"]=g);""!==l&&(c["margin-left"]=l);""!==m&&(c["border-top-width"]=m);""!==h&&(c["border-right-width"]=h);""!==n&&(c["border-bottom-width"]=n);""!==q&&(c["border-left-width"]=q);""!==p&&(c["padding-top"]=p);""!==k&&(c["padding-right"]=k);""!==r&&(c["padding-bottom"]=r);""!==x&&(c["padding-left"]=x);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=f);d=b.find(".tdc-css-border-color");
f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==u&&(c["border-radius"]=u);""!==z&&(c.width=z);""!==A&&(c["shadow-size"]=A);u=b.find(".tdc-css-shadow-color");z=u.val().trim();""!==z?c["shadow-color"]=z:(u=u.data("no_value"),a.isUndefined(u)||1!==u||(c["shadow-color"]="no_value"));""!==v&&(c["shadow-offset-h"]=v);""!==w&&(c["shadow-offset-v"]=w);v=b.find(".tdc-css-bg-color");w=v.val().trim();""!==w?c["background-color"]=
w:(v=v.data("no_value"),a.isUndefined(v)||1!==v||(c["background-color"]="no_value"));v=b.find(".tdc-css-bg-image");v.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(v=v.data("image_link"),a.isUndefined(v)||("no_value"===v?c["background-image"]="no_value":""!==v&&(c["background-image"]='url("'+v+'")')));v=b.find(".tdc-css-bg-style");w=v.val().trim();""===w||v.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-style"]=w);v=b.find(".tdc-css-bg-position");
w=v.val().trim();""===w||v.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=w);""!==t&&(c.opacity=t);t=b.find(".tdc-css-color-1-overlay");v=t.val().trim();""!==v?c["color-1-overlay"]=v:(t=t.data("no_value"),a.isUndefined(t)||1!==t||(c["color-1-overlay"]="no_value"));t=b.find(".tdc-css-color-2-overlay");v=t.val().trim();""!==v?c["color-2-overlay"]=v:(t=t.data("no_value"),a.isUndefined(t)||1!==t||(c["color-2-overlay"]="no_value"));""!==B&&(c["gradient-direction"]=
...
var m=c.data("max_"+l);l=c.data("step_"+l);c.get(0).min=b;c.get(0).max=m;c.get(0).step=l;""===g?(d.val(f),c.val(f)):(d.val(g),c.val(g));c=c.get(0)}f="";d=jQuery(c).parent().find('input[type="radio"]:checked');d.length&&(f=jQuery(d[0]).data("unit_value"));"focusin"===a.type?c.oldValue=c.value+f:(a=c.value+f,f=tdcIFrameData.getModel(jQuery(c).data("model_id")),tdcSidebarController.onUpdate(f,jQuery(c).data("param_name"),c.oldValue,_.escape(a)),c.oldValue=a)});a.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),l=d.get(0),m="",h=f.data("default_value"),n=tdcIFrameData.getModel(d.data("model_id")),q=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[n.attributes.tag],k=n="";var r=[];for(var x=0;x<p.params.length;x++)if(q===p.params[x].param_name){x=p.params[x].tdc_values;for(var u in x)x.hasOwnProperty(u)&&(r.push(x[u].unit),
""===n||""===k)&&(n=x[u].value,k=x[u].unit);break}f.length&&(m=f.data("unit_value"));if("range"===b.attr("type"))r=d.val(),g.val(r),f.data("last_value",r),g.val(r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+m,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");r=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
r||_.isUndefined(h)||""===h?(d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+m,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),d.data("range_value",n),d.data("range_unit",k),d.val(n),m=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=m.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),m.prop("checked",
!0),l.min=u,l.max=f,l.step=p,l.value=n,m.data("last_value",n),g.val(n));else if(""===r)if(m=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof m)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),d.data("range_value",n),d.data("range_unit",k),d.val(n),m=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=m.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),m.prop("checked",
!0),l.min=u,l.max=f,l.step=p,l.value=n,m.data("last_value",n),g.val(n),c.addClass("tdc-css-inherited");else for(x=0;x<p.params.length;x++){if(q===p.params[x].param_name){r=[];g=[];x=p.params[x].tdc_values;for(u in x)x.hasOwnProperty(u)&&r.push(x[u].unit);for(x=0;x<r.length&&!(g=m.split(r[x]),1<g.length);x++);g.length&&(n=g[0],k=r[x],d.data("range_value",n),d.data("range_unit",k),m=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=m.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+
p),m.prop("checked",!0),l.min=u,l.max=f,l.step=p,l.value=n,m.data("last_value",n),c.find('input[type="text"]').val(n));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+m,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
q=f.data("last_value");p=f.data("unit");u=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);l.min=u;l.max=f;l.step=p;""===q?(g.val(h),d.val(h),r=h):(g.val(q),d.val(q),r=q);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+m,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}m="";c=jQuery(l).parent().find('input[type="radio"]:checked');c.length&&(m=jQuery(c[0]).data("unit_value"));"focusin"===a.type?l.oldValue=l.value+m:(c=jQuery(l),
a=c.data("data-to-save"),n=tdcIFrameData.getModel(c.data("model_id")),l.oldValue!==a&&(tdcSidebarController.onUpdate(n,jQuery(l).data("param_name"),l.oldValue,_.escape(a)),l.oldValue=a))});a.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(a){if("focusin"===a.type)this.oldValue=this.value;else{a=jQuery(this);var b=a.val();a.is(":checked")||(b="");var c=tdcIFrameData.getModel(a.data("model_id"));tdcSidebarController.onUpdate(c,a.data("param_name"),this.oldValue,b);this.oldValue=
...
function(){var a=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');a.length&&tdcSidebarPanel.toggleEnableFSLinkPostParams(a)});a.on("change",'.tdc-fs-link-post-toggle input[type="checkbox"]',function(){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(this))});a.on("mousedown",function(a){var b=jQuery("#tdc-sidebar"),c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),f=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),l=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||
(c.hide(),b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-gradient-wrap")||(d.hide(),b.after(d))):d=tdcSidebar.buildGradient();f.length?f.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-colorpicker-wrap")||(f.hide(),b.after(f),f.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):f=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(a.target)&&(g.hide(),b.after(g));!l.length||l.get(0).contains(a.target)||
jQuery(".tdc-preset-values").get(0).contains(a.target)?l.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(a.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100):l.is(":visible")&&(l.hide(),b=jQuery(a.target),
jQuery(".tdc-top-buttons").get(0).contains(a.target)||b.hasClass("tdc-top-buttons")||jQuery(".tdc-sidebar-bottom").get(0).contains(a.target)||b.hasClass("tdc-sidebar-bottom")||jQuery(".tdc-current-element-head").get(0).contains(a.target)||b.hasClass("tdc-current-element-head")?jQuery(".tdc-current-element-head").get(0).contains(a.target)||b.hasClass("tdc-current-element-head")?(tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
...
(this.oldValue=f));"11"===this.oldValue&&("23_13"===a||"13_23"===a||"13_13_13"===a)||"23_13"===this.oldValue&&("11"===a||"13_23"===a||"13_13_13"===a)||"13_23"===this.oldValue&&("11"===a||"23_13"===a||"13_13_13"===a)||"13_13_13"===this.oldValue&&("11"===a||"23_13"===a||"13_23"===a)?(tdcIFrameData.changeRowModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0)):this.oldValue!==a&&(tdcIFrameData.changeFluidStructureModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0));this.oldValue=a},300)});a.on("change",
...
l="",m=0;m<g.length;m++){var h=a.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[m]+":first");if(h.length){var n=h.find('[data-model_id="'+c+'"]');n.length&&(n.val(""),n.data("responsive",""),h.removeClass("tdc-css-inherited"),l=h.find(".tdc-inherit"),l.length&&l.hide(),l=n.data("placeholder"),"undefined"!==typeof l&&n.attr("placeholder",l),l=n.data("param_name"),delete f[l],n=n.attr("name"),tdcSidebarPanel.deleteResponsiveValues(n))}}d.set("attrs",f);tdcSidebarController.onUpdate(d,l,"","")}})});
...
g;g--){var l=window.tdcAdminSettings.tdcSavings.recentFonts[g],m=a[l];_.isUndefined(m)||jQuery('<div class="tdc-recent-font-settings" data-value="'+l+'" data-model_id="'+e+'" data-param_name="'+d+'"><span class="tdc-font-name">'+m+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(f)}}b.after(f);f.toggle()}});a.on("click",".tdc-font-delete",function(a){a.stopImmediatePropagation();var b=jQuery(this).closest(".tdc-font-settings");a=b.data("name");a=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,
...
f=!0;break}f||(a[g.param_name]="")}}for(l in e)switch(e=l.split("-"),e.length){case 2:if(!_.has(a,l)){d=e[0];e=!1;for(var m in a)if(d===a[m]&&1===m.split("-").length){e=!0;break}if(!e){var h;for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){var n=h;break}_.has(a,n)&&""===a[n]&&window.tdcAdminSettings.globalStyle[n]===d&&(e=!0)}e||delete c[l]}break;case 3:d=e[0];b=e[2];for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],
d)){n=h;break}e=!1;for(m in a)if(d===a[m]&&m===n+"-"+b){e=!0;break}e||_.has(a,n+"-"+b)&&""===a[n+"-"+b]&&window.tdcAdminSettings.globalStyle[n]===d&&(e=!0);e||delete c[l]}return c}},getCurrentListAtts:function(a,c,b){_.isUndefined(c)&&(a=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(a),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));a=c.get("tag");c=c.get("attrs");var e=_.clone(c);if(!_.isUndefined(e)){var d={};c={};for(var f in e)0===f.indexOf("tds_")&&(d[f]=
e[f]);f=window.tdcAdminSettings.mappedShortcodes[a].params;for(var g=0;g<f.length;g++){var l=!1,m=f[g];if(0===m.param_name.indexOf("tds_")){for(var h in d)if(m.param_name===h){c[h]=d[h];l=!0;break}l||(c[m.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var n in c)if(f===c[n]&&1===n.split("-").length){d=!0;break}if(!d){var q;for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){var p=q;break}_.has(c,p)&&
""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0)}d||delete e[h]}break;case 3:f=d[0];l=d[2];for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){p=q;break}d=!1;for(n in c)if(f===c[n]&&n===p+"-"+l){d=!0;break}d||_.has(c,p+"-"+l)&&""===c[p+"-"+l]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var y=[],r;for(r in window.tdcAdminSettings.listStyles[b])if(r===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][r].length;g++)h=
window.tdcAdminSettings.listStyles[b][r][g],_.isArray(h)?_.map(h,function(a){_.isUndefined(e[a])||(_.isUndefined(y[g])&&(y[g]=[]),y[g].push(e[a]))}):_.isUndefined(e[h])||(_.isArray(e[h])&&e[h].length?y[g]=e[h][0]:y[g]=e[h]);break}return y}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next(".tdc-property-editor_css-title").length?(c.next(".tdc-property-editor_css-title").toggle(),
...
b.hasClass("tdc-disabled")||b.addClass("tdc-disabled")):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled")},toggleEnableFSLinkPostParams:function(a){var c=a.closest(".tdc-property-wrap"),b=jQuery(".tdc-property-make_child");a.is(":checked")?c.hasClass("tdc-disabled")?b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled")},bindPanelToModel:function(a,c){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||
tdcSidebarPanel._currentBoundModel.cid!==a.cid||!_.isUndefined(c)&&(_.isUndefined(c)||!0===c)){c=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=a;for(var b=[],e=0;e<c.params.length;e++){var d=tdcSidebarPanel._defaultGroupName;_.isEmpty(c.params[e].group)||(d=c.params[e].group);b.push(d)}b=_.uniq(b);var f=d="",g=tdcSidebar.getCurrentTabId(),l,m;d+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';
var h=m=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var n=tdcUtil.makeSafeForCSS(f);0===e?(l='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',m='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+n?h+='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':
(l=m,h+='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}d=d+(l+h)+"</div>";h=m=l=e="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "phone":h="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "landscape":l="selected";break;case "portrait":m="selected";break;case "phone":h="selected"}d+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';
tdcState.isMobileComposer()?d=d+('<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+e+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div><div class="tdc-responsive-phone ')+(h+'" title="Portrait viewport"><span class="tdc-phone-icon"></span></div>'):(d+='<div class="tdc-responsive-all '+e+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>',"Newspaper"===window.tdcAdminSettings.themeName&&(d+='<div class="tdc-responsive-tablet-landscape '+
l+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>'),d+='<div class="tdc-responsive-tablet-portrait '+m+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>',d+='<div class="tdc-responsive-phone '+h+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>');d+="</div>";d+="</div>";d+='<div class="tdc-search">';d+='<i class="td-icon-search"></i>';d+='<input type="text" placeholder="Search settings..." />';d+="</div></div>";
d+='<div class="tdc-sidebar-sticky-a"></div>';d+='<div class="tdc-sidebar-sticky-b"></div>';d+='<div class="tdc-tab-content-wrap">';h=m=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);n=tdcUtil.makeSafeForCSS(f);f="tdc-tab-no-design";var k=a.get("tag");"css"===n&&(f="tdc-tab-design");0===e?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">',m='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">',n=window.tdcAdminSettings.mappedShortcodes[k].tdc_start_values,
a.unset("presetValues"),_.isUndefined(n)||(n=JSON.parse(window.atob(n)),_.isArray(n)&&1<n.length&&a.set("presetValues",n)),a.has("presetValues")&&(n=a.get("presetValues"),h+=tdcSidebarPanel._addPresetValuesSelector(n,a))):_.isUndefined(g)||g!=="td-tab-"+n?h+='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">':(l=m,h+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">');h+=tdcSidebarPanel._bindGroupAndGetHtml(b[e],c,a);n=' data-model_id="'+a.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&
(h+='<div class="tdc-sidebar-row-buttons">',h+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+n+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',h+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+n+' title="Get the current styles\' settings">CONSOLE: style presets</div>',h+="</div>");h+="</div>"}d=d+(l+h)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(d);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",
function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),b=a.find("[data-responsive]"),c=b.attr("name"),d=b.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[c]=JSON.parse(e)}catch(z){d=
...
(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,
...
window.tdcPostSettings.mobileMenuId;c.set("attrs",d)}var f=d=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,"toggle_disable_params")&&""!==a.toggle_disable_params&&(l='data-disable-params="'+a.toggle_disable_params+'"');var m="";_.has(a,"toggle_enable_params_reverse")&&!0===
a.toggle_enable_params_reverse&&(m='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var n="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(n='data-disabled-by="'+a.toggle_disabled_by+'"');var k="",p="",y=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&y.length<=parseInt(a.tdc_min_options))return k;for(var r=0;r<y.length;r++){var x=!1,u="",z="",A="",v=y[r],w=String(tdcSidebarPanel._getParameterCurrentValue(a,
c)),t=String(a.value[y[r]]);_.has(a,"options_to_disable")&&""!==a.options_to_disable&&(z=a.options_to_disable);_.isObject(a.value[y[r]])&&(x=!0,t=_.values(a.value[y[r]])[0],v=_.keys(a.value[y[r]])[0]);if(d||f)0===r&&""===w&&(w=t),w===t&&(u=" checked "),z=_.uniqueId(),A=t,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(A="col_"+A),p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+z+'" name="'+
tdcSidebarPanel._getParameterDomName(a)+'" '+u+' value="'+t+'">',d?(u="",x&&(u="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+u+'" for="'+z+'" title="'+v+'"><div class="'+A+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+v+'">'+t+"</label>";else{w===t&&(u=' selected="selected" ');if("__"===t&&-1!==v.search("--")||-1<z.indexOf(t)&&""!==t)A=" disabled ";p+="<option "+u+" "+A+' value="'+t+'">'+v+"</option>"}}y="";_.has(a,"description")&&
""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':y=' title="'+a.description+'" ');k+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+m+" "+h+" "+n+">";k+='<div class="tdc-property-title"><span class="tdc-search-data"'+y+">"+a.heading+"</span>";b="";e="#";"tdb_flex_block_builder"===c.get("tag")&&"cloud_tpl_module_id"===a.param_name&&(b="tdc-edit-cloud_tpl_module_id",g='style="margin-left: 10px"',_.has(c.get("attrs"),"cloud_tpl_module_id")?""===
c.get("attrs").cloud_tpl_module_id.trim()?g='style="margin-left: 10px; visibility: hidden"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post_id="+c.get("attrs").cloud_tpl_module_id.trim()+"&td_action=tdc&tdbTemplateType=module"):g='style="margin-left: 10px; visibility: hidden"',k+='<a href="'+e+'" class="'+b+'" target="_blank" '+g+">Edit</a>");k+='</div><div class="tdc-property">';d||f?k+=p:(k+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" class="'+b+'">',k=k+p+"</select>");k=k+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return k+"</div>"},addDropDownResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=!1,f=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+
'"');var l="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');var h="",n="",k=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&k.length<=parseInt(a.tdc_min_options))return h;var p=' data-responsive="" ',y=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var r=JSON.parse(window.atob(y));p=' data-responsive="'+
y+'" ';"undefined"!==typeof r[tdcSidebar.currentViewportSettings.name]&&(y=r[tdcSidebar.currentViewportSettings.name])}catch(t){}for(r=0;r<k.length;r++){var x=!1,u="",z="",A=k[r],v=String(a.value[k[r]]);_.isObject(a.value[k[r]])&&(x=!0,v=_.values(a.value[k[r]])[0],A=_.keys(a.value[k[r]])[0]);if(d||f){0===r&&""===y&&(y=v);y===v&&(u=" checked ");z=_.uniqueId();var w=v;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(w="col_"+w);n+='<input class="tdc-property-input-radio" type="radio" '+
tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+u+' value="'+v+'" '+p+">";d?(u="",x&&(u="tdc-standard-value"),n+='<label class="tdc-property-input-radio-label '+u+'" for="'+z+'" title="'+A+'"><div class="'+w+'"></div></label>'):n+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+A+'">'+v+"</label>"}else y===v&&(u=' selected="selected" '),"__"===v.substring(0,2)&&-1!==A.search("--")&&(z=" disabled "),n+="<option "+u+" "+
z+' value="'+v+'">'+A+"</option>"}k="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':k=' title="'+a.description+'" ');h+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+m+">";h+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';h+='<div class="tdc-property">';
d||f?h+=n:(h+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+p+k+">",h=h+n+"</select>");h=h+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return h+"</div>"},addCheckBox:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="",g=tdcSidebarPanel._getParameterCurrentValue(a,
c);"product_cat_type_action"===a.param_name?""!==g&&"single_selection"!==g&&(f=" checked "):""!==g&&(f=" checked ");var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(l='data-enable-params="'+a.toggle_enable_params+'"');var m="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(m='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var n="";_.has(a,"toggle_disabled_by")&&
""!==a.toggle_disabled_by&&(n='data-disabled-by="'+a.toggle_disabled_by+'"');g="";var k=tdcSidebarPanel._getParameterClasses(a);k.includes("tdc-filter-multiple")&&(g=' title="'+a.description+'" ');b='<div class="'+k+'" '+b+" "+e+" "+l+" "+m+" "+h+" "+n+'><div class="tdc-property-title"><span class="tdc-search-data"'+(d+">"+a.heading+"</span></div>");b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+
f+" "+g+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addCheckBoxResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';"undefined"!==typeof l[tdcSidebar.currentViewportSettings.name]&&(g=l[tdcSidebar.currentViewportSettings.name])}catch(n){}""!==
g&&(d=" checked ");l="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':l=' title="'+a.description+'" ');g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var m="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(m='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+
'"');b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+m+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+l+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+d+f+
"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addRange:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var l="";_.has(a,"range_step")&&""!==
a.range_step&&(l=a.range_step);var m="";_.has(a,"value")&&""!==a.value&&(m=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,c));var n="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(n='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(p='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+n+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+f+'" step="'+l+'" value="'+
h+'" />');b=b+('<input type="text" class="tdc_range_value" data-default_value="'+m+'" value="'+h+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);
var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var l="";_.has(a,"range_step")&&""!==a.range_step&&(l=a.range_step);var m="";_.has(a,"value")&&""!==a.value&&(m=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&tdcSidebarPanel._getParameterCurrentValue(a,c);var h="";_.has(a,"placeholder")&&""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var n="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(n='data-enable-params="'+
a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');var y=' data-responsive="" ',r=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var x=JSON.parse(window.atob(r));y=' data-responsive="'+r+'" ';r="undefined"===typeof x[tdcSidebar.currentViewportSettings.name]?"":x[tdcSidebar.currentViewportSettings.name]}catch(u){}b=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+n+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+r+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+f+'" step="'+l+'" value="'+r+'" '+y+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+
m+'" '+h+' value="'+r+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,
"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');var m=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),k="",q="",p=[],y="",r="",x="",u="",z="",A="",v="",w;for(w in m)m.hasOwnProperty(w)&&(p.push(m[w].unit),""===r||""===y)&&(u=m[w].unit,r=' data-range_unit="'+u+'" ',x=m[w].value,y=' data-range_value="'+x+'" ',z=m[w].range_min,
A=m[w].range_max,v=m[w].range_step);if(""!==h){for(var t=[],B=0;B<p.length&&!(t=h.split(p[B]),1<t.length);B++);t.length&&(u=p[B],r=' data-range_unit="'+u+'" ',x=t[0],y=' data-range_value="'+x+'" ')}for(w in m)m.hasOwnProperty(w)&&(h=_.uniqueId(),k+=" data-value_"+w+'="'+m[w].value+'" ',k+=" data-min_"+w+'="'+m[w].range_min+'" ',k+=" data-max_"+w+'="'+m[w].range_max+'" ',k+=" data-step_"+w+'="'+m[w].range_step+'" ',p=m[w].value,t="",m[w].unit===u&&(p=x,z=m[w].range_min,A=m[w].range_max,v=m[w].range_step,
t="checked"),q+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+w+'" data-unit_value="'+m[w].unit+'" type="radio" id="'+h+'" '+t+' data-default_value="'+m[w].value+'" data-last_value="'+p+'"/>',q+='<label for="'+h+'">'+m[w].unit+"</label>");b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+
(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+y+" "+r+" "+k+' min="'+z+'" max="'+A+'" step="'+v+'" value="'+x+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+q+'</div><input type="text" class="tdc_range_value" value="'+(x+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&
""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(l='data-enabled-by="'+a.toggle_enabled_by+'"');var m=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),k="",q="",p=[],y=' data-responsive="" ',r="",x="",u="",z="",A="",v="",w="",t;for(t in m)m.hasOwnProperty(t)&&(p.push(m[t].unit),""===x||""===r)&&(z=m[t].unit,x=' data-range_unit="'+z+'" ',u=m[t].value,r=' data-range_value="'+u+'" ',A=m[t].range_min,v=m[t].range_max,w=m[t].range_step);if(""!==h){var B=h;try{var C=JSON.parse(window.atob(h));y=' data-responsive="'+h+'" ';B="undefined"===
typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(D){}if(""!==B){h=[];for(C=0;C<p.length&&!(h=B.split(p[C]),1<h.length);C++);h.length&&(z=p[C],x=' data-range_unit="'+z+'" ',u=h[0],r=' data-range_value="'+u+'" ')}}for(t in m)m.hasOwnProperty(t)&&(p=_.uniqueId(),k+=" data-value_"+t+'="'+m[t].value+'" ',k+=" data-min_"+t+'="'+m[t].range_min+'" ',k+=" data-max_"+t+'="'+m[t].range_max+'" ',k+=" data-step_"+t+'="'+m[t].range_step+'" ',B=m[t].value,h="",
m[t].unit===z&&(B=u,A=m[t].range_min,v=m[t].range_max,w=m[t].range_step,h="checked"),q+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+t+'" data-unit_value="'+m[t].unit+'" type="radio" id="'+p+'" '+h+' data-default_value="'+m[t].value+'" data-last_value="'+B+'"/>',q+='<label for="'+p+'">'+m[t].unit+"</label>");b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+r+" "+x+" "+k+" "+y+' min="'+A+'" max="'+v+'" step="'+w+'" value="'+u+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+q+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+
"</span>";return b+="</div>"},addIconSelector:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');
var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' data-selected_icon="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'">');
b=b+'</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(b,d){b=jQuery(d);a.param_name===b.data("param_name")&&(d=jQuery("#tdc-icon-selector"),d.length||(d=tdcSidebar.buildIconSelector()),d=d.find('.tdc-icon-selector-content > span[data-font_class="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'"]'),""!==
tdcSidebarPanel._getParameterCurrentValue(a,c)&&(b.html(d.html()),b.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button")))})});return b},addUploadImage:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+
a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-image-wrap tdc-no-image-selected" '+
(tdcSidebarPanel._getParamterDataAtts(a,c)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");b=b+'</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(b,d){var e=jQuery(d);if(!e.parent().parent(".tdc-bg-upload").length&&a.param_name===e.data("param_name")){var f=
tdcSidebarPanel._getParameterCurrentValue(a,c);""!==f&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:f,action:"tdc_ajax_get_image_url"}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(e.attr("style","background-image: url('"+a.image_url+
"')").removeClass("tdc-no-image-selected"),e.data("image_link",a.image_url),e.data("image_id",f),e.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,b,c){})}})});return b},addTextField:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var g=jQuery("<div>"+a.description+"</div>");
a.description===g.text()?d=' title="'+a.description+'" ':f='<div class="tdc-description">'+a.description+"</div>"}g="";_.has(a,"placeholder")&&""!==a.placeholder&&(g=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var l=tdcSidebarPanel._getParameterCurrentValue(a,c);if(""===l){var k=Math.floor(65536*(1+Math.random())).toString(16).substring(1);"modal_id"===a.param_name?(l="td_m_"+k,tdcSidebarController.onUpdate(c,"modal_id","",l)):"tc_id"===a.param_name&&(l="td_tc_"+k,tdcSidebarController.onUpdate(c,
"tc_id","",l))}"undefined"!==typeof l&&null!==l&&0===l.toString().indexOf("td_encval")&&(l=l.replace("td_encval",""),l=window.atob(l));k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+
tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+h+" "+n+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span>";d="";e="#";"tdm_block_popup"===c.get("tag")&&"page_id"===a.param_name&&(d="tdc-edit-page_id",k='style="margin-left: 10px"',_.has(c.get("attrs"),"page_id")?""===c.get("attrs").page_id.trim()?k='style="margin-left: 10px; visibility: hidden"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post="+c.get("attrs").page_id.trim()+
"&action=edit"):k='style="margin-left: 10px; visibility: hidden"',b+='<a href="'+e+'" class="'+d+'" target="_blank" '+k+">Edit</a>");b=b+'</div><div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" '+g+' value="'+l+'" class="'+d+'" />');b=b+f+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+="</div>"},addDoShortcode:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+
a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':f=' title="'+a.description+'" ');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+">";b+='<div class="tdc-property-title"><span'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea tdc-textarea-visible" '+tdcSidebarPanel._getParamterDataAtts(a,c)+">"+decodeURIComponent(atob(tdcSidebarPanel._getParameterCurrentValue(a,
c)))+"</textarea>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";a=jQuery("body");a.on("change","#woo_shortcode",function(a){jQuery(a.change);a=atob(a.target.value);jQuery("#"+d).val(a).trigger("focusin")});a.on("keyup focusin","#"+d,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id")),d=window.btoa(encodeURIComponent(b.val())),e=window.btoa(encodeURIComponent(a.target.oldValue));setTimeout(function(){tdcSidebarController.onUpdate(c,b.data("param_name"),
e,d)},500)});return b},addTextFieldResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var g=jQuery("<div>"+a.description+"</div>");a.description===g.text()?d=' title="'+a.description+'" ':f='<div class="tdc-description">'+a.description+"</div>"}g="";_.has(a,"placeholder")&&""!==a.placeholder&&(g=' data-placeholder="'+a.placeholder+
'" placeholder="'+a.placeholder+'" ');var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(l='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var n=' data-responsive="" ',q=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var p=JSON.parse(window.atob(q));
n=' data-responsive="'+q+'" ';q="undefined"===typeof p[tdcSidebar.currentViewportSettings.name]?"":p[tdcSidebar.currentViewportSettings.name]}catch(y){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+l+" "+k+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" value="'+
q+'" '+g+n+d+"/>");b=b+f+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+="</div>"},addTextArea:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="",g="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var l=jQuery("<div>"+a.description+"</div>");a.description===l.text()?f=' title="'+a.description+'" ':g='<div class="tdc-description">'+
a.description+"</div>"}l="";_.has(a,"placeholder")&&""!==a.placeholder&&(l=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+
'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+h+" "+n+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea tdc-textarea-visible" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+l+'">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+g+'</div><span class="tdc-param-name">'+
(a.param_name+"</span>");b+="</div>";jQuery("body").on("keyup focusin","#"+d,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=b.val(),e=a.target.oldValue;tdcSidebarController.onUpdate(c,b.data("param_name"),e,d)}a.target.oldValue=a.target.value});return b},addTextAreaHtml:function(a,c){_.has(a,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+c.cid+'" data-mapped_parameter_name="'+
a.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="",g="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var l=jQuery("<div>"+a.description+"</div>");a.description===l.text()?f=' title="'+a.description+'" ':g='<div class="tdc-description">'+a.description+"</div>"}l="";_.has(a,"placeholder")&&""!==a.placeholder&&
(l=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+
b+" "+e+" "+k+" "+h+" "+n+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,c)+" "+l+">"+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+g+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+
...
_.has(a,"description")&&""!==a.description&&""!==b&&(e='data-info-descr="'+a.description+'"');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+
'" '+b+" "+e+" "+f+" "+g+" "+l+">";b=b+'<div class="tdc-property-editor_expand"><span></span><div class="tdc-editor-toggle tdc-html-ace-editor-expand-collapse"></div></div><div class="tdc-property tdc-raw-html-ace"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,c)+">"+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+('<div id="'+d+'_ace_html" class="tdc-raw-html-ace-editor"></div></div><span class="tdc-param-name">')+(a.param_name+"</span>");b+=
"</div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,c)}}).done(function(a,b,c){if("success"===b)if(_.isObject(a)&&_.has(a,"errors"))new tdcNotice.notice(a.errors,!0,
!1);else{var e=jQuery("#"+d);e.html(a.parsed_content);var f=ace.edit(d+"_ace_html");f.$blockScrolling=Infinity;f.getSession().setValue(e.val());f.getSession().on("change",function(){var a=f.getSession().getValue(),b=tdcIFrameData.getModel(e.data("model_id")),c=e.data("param_name");e.val(a);a=window.btoa(encodeURIComponent(a));tdcSidebarController.onUpdate(b,c,"",a)});f.setTheme("ace/theme/textmate");f.getSession().setMode("ace/mode/html");f.setOptions({enableBasicAutocompletion:!0,enableSnippets:!0,
...
addFontTitle:function(a,c){var b="",e="",d="";_.has(a,"info_img")&&""!==a.info_img&&(e='data-info-img="'+a.info_img+'"',_.has(a,"description")&&""!==a.description&&(d='data-info-descr="'+a.description+'"'));var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(k='data-enabled-by="'+a.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-font-title '+tdcSidebarPanel._getParameterClasses(a)+'" '+e+" "+d+" "+f+" "+g+" "+k+'><span class="tdc-search-data tdc-search-notice-font">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</span></div>"},addFontSettings:function(a,c){var b="",e="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(e='data-enable-params="'+a.toggle_enable_params+'"');var d="";_.has(a,"toggle_enable_params_reverse")&&!0===
...
e),_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?(a.val(""),d.val("")):(a.val(c),d.val(c),d.attr("placeholder",c),b.addClass("tdc-css-inherited"))):(a.val(c),d.val(c),b.removeClass("tdc-css-inherited"));else if(b.hasClass("tdc-property-range_multiple-responsive")){e=tdcIFrameData.getModel(a.data("model_id"));var f=a.data("param_name"),g=window.tdcAdminSettings.mappedShortcodes[e.attributes.tag];e=[];for(var k=d="",m=0;m<g.params.length;m++)if(f===
g.params[m].param_name){f=g.params[m].tdc_values;for(var h in f)f.hasOwnProperty(h)&&(e.push(f[h].unit),""===d||""===k)&&(d=f[h].value,k=f[h].unit);break}_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)&&(a.data("range_value",d),a.data("range_unit",k),a.val(d),h=b.find('input[type="radio"][data-unit_value="'+k+'"]'),m=h.data("unit"),f=a.data("min_"+m),k=a.data("max_"+m),m=a.data("step_"+m),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=k,g.step=m,
g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):b.addClass("tdc-css-inherited")):b.removeClass("tdc-css-inherited");if(!_.isUndefined(c)){d=[];for(m=0;m<e.length&&!(d=c.split(e[m]),1<d.length);m++);d.length&&(d=d[0],k=e[m],a.data("range_value",d),a.data("range_unit",k),a.val(d),h=b.find('input[type="radio"][data-unit_value="'+k+'"]'),m=h.data("unit"),f=a.data("min_"+m),k=a.data("max_"+m),m=a.data("step_"+
m),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=k,g.step=m,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d))}}},showShortcodeFromPath:function(a){if(!_.isUndefined(a)){a=a.toString().split("_");var c;a.forEach(function(a,b){""!==a&&(_.isUndefined(c)?c=tdcIFrameData.tdcTopCollection.at(a):(b=c.get("childCollection"),!_.isUndefined(b)&&b.length>a&&(c=b.at(a))))});if(!_.isUndefined(c)){var b=c.get("blockUid");if(!_.isUndefined(b)){var e=tdcAdminIFrameUI.getLiveIframe();a=e.contents().find("#"+
