...
define("TD_THEME_VERSION", "12.5.1");
...
//var_dump(defined('TD_COMPOSER') && td_util::get_option('tds_white_label'));
		...
		tagdiv_global::$theme_plugins_list = array(
			array(
				...
				'source' => 'https://cloud.tagdiv.com/td_plugins/td-composer/e12b81d6cbdf467845997a891495df2cx/td-composer.zip', // The plugin source
			...
			array(
				...
				'source' => 'https://cloud.tagdiv.com/td_plugins/td-cloud-library/0390de2d4222fae8efaeae107c326a4e/td-cloud-library.zip', // The plugin source
				'required' => true, // If false, the plugin is only 'recommended' instead of required
				'version' => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
				'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
				'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            ...
            array(
                ...
                'source' => 'https://cloud.tagdiv.com/td_plugins/td-woo/49c6c0bef9252eb194c60274eed64914/td-woo.zip', // The plugin source
                'required' => false, // If false, the plugin is only 'recommended' instead of required
                'version' => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
                'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
                'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            ...
            array(
                ...
                'source' => 'https://cloud.tagdiv.com/td_plugins/td-standard-pack/ea43e379b839e31c21a92e9daeba4b6d/td-standard-pack.zip', // The plugin source
                'required' => false, // If false, the plugin is only 'recommended' instead of required
                'version' => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
                'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
                'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
